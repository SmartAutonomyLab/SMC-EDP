...
% When saving, append the file name to the folder path.
save(append(folder_path, '/correctness_of_phi_table.mat'), 'phi_array');
fprintf('Done!\n');
...
% When saving, append the file name to the folder path.
save(append(folder_path, '/seed_sequences.mat'), 'seed_sequences');
fprintf('Done!\n');
...
% When saving, append the file name to the folder path.
save(append(folder_path, '/p_phi_data.mat'), 'p_phi_data');
fprintf('Done!\n');
